...
public class SecurityConfig {
    private static final String[] WHITE_LIST_URL = {"/api/v1/user/register", "/api/v1/user/authenticate", "/api/v1/user/refresh-token", "/api/v1/user/forgot-password", "/api/v1/user/reset-password","/gs-guide-websocket", "/api/v1/account/addFunds"};
